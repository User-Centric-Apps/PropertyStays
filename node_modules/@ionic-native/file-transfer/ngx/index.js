...
var FileTransfer = /** @class */ (function (_super) {
    tslib_1.__extends(FileTransfer, _super);
    ...
    FileTransfer = tslib_1.__decorate([
        Injectable()
    ], FileTransfer);
    return FileTransfer;
}(IonicNativePlugin));
