...
var ShareService = /** @class */ (function () {
    function ShareService(socialSharing) {
    ...
    ShareService.prototype.shareApp = function () {
        this.socialSharing
            .share('Whey not try PropertyStays.com app!', 'Share PropertyStays.com with your friends', 'https://propertystays.com/wp-content/uploads/2019/04/Barcelona-city-breaks-400x400.jpg', 'http://PropertyStays.com')
            .then(function () {
            console.log('Shared');
        })
    ...
    ShareService.prototype.shareAppWithOptions = function (options) {
        var _this = this;
        this.socialSharing
    ...
    ShareService.prototype.shareWithOptions = function (msg, subj, file, link) {
        var _this = this;
        var options = {
    ...
    ShareService.prototype.onSuccess = function (result) {
        console.log('success func');
        console.log('Share completed? ' + result.completed); // On Android apps mostly return false even while it's true
        console.log('Shared to app: ' + result.app);
    };
    ShareService.prototype.onError = function (msg) {
