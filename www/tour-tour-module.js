...
module.exports = ".ratings .rating-num {\n  text-align: center; }\n  .ratings .rating-num h2.rate {\n    text-align: center;\n    color: var(--ion-color-primary);\n    font-size: 60px;\n    line-height: 72px; }\n  .ratings .rating-num p {\n    font-size: 15px;\n    line-height: 20px; }\n  .ratings .stars {\n  padding: 0 5px; }\n  .ratings .stars ion-icon {\n    width: 10px;\n    height: 10px;\n    opacity: 0.6; }\n  .ratings .progress {\n  padding: 0 5px; }\n  .comments .comment {\n  background: #F5F5F5;\n  border-radius: 8px;\n  padding: 2px 10px;\n  margin: 10px 0; }\n  .comments .comment ion-icon.star {\n    width: 14px;\n    height: 14px; }\n  .comments .comment p.title {\n    font-size: 17px;\n    line-height: 20px;\n    margin: 5px 0; }\n  .comments .comment p.author,\n  .comments .comment p.content,\n  .comments .comment p.date {\n    font-size: 13px;\n    line-height: 16px;\n    margin: 5px 0; }\n  .comments .comment p.date {\n    opacity: 0.6; }\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
module.exports = ".map-canvas {\n  width: 100%;\n  height: 250px;\n  border-radius: 10px;\n  margin-bottom: 20px; }\n  .map-canvas ion-img {\n    opacity: 0;\n    display: none; }\n  ion-item.nopadding {\n  --padding-start: 0;\n  --padding-end: 0;\n  --inner-padding-start: 0;\n  --inner-padding-end: 0; }\n  .prop-detail {\n  border-bottom: 1px solid #E0E0E1;\n  margin-bottom: 5px; }\n  .prop-detail ion-item {\n    --padding-start: 0;\n    --padding-end: 0;\n    --inner-padding-start: 0;\n    --inner-padding-end: 0; }\n  .prop-detail .prop-data h3.type {\n    color: #627790;\n    font-size: 12px;\n    line-height: 14px;\n    font-weight: 700;\n    margin-bottom: 10px; }\n  .prop-detail .prop-data p.location {\n    color: #263646;\n    font-size: 14px;\n    line-height: 17px;\n    margin-bottom: 10px; }\n  .prop-detail .prop-data p.price {\n    color: var(--ion-color-primary);\n    font-size: 17px;\n    line-height: 20px; }\n  .prop-detail .owner {\n    text-align: center; }\n  .prop-detail .owner ion-item {\n      display: inline-block;\n      margin-top: 5px; }\n  .prop-detail .owner ion-item ion-avatar.owner-image {\n        margin: 15px 0 0;\n        align-self: center;\n        justify-self: center; }\n  .prop-detail .owner p.owner-name {\n      color: #999999;\n      font-size: 8.8px;\n      line-height: 11px;\n      font-weight: 700; }\n  .features {\n  border-bottom: 1px solid #E0E0E1;\n  margin-bottom: 5px; }\n  .features ion-item ion-icon {\n    margin: 0 5px 0 0; }\n  .features ion-item ion-label {\n    margin: 0; }\n  .features ion-item ion-label span.heavy {\n      font-weight: 700; }\n  .aminities {\n  border-bottom: 1px solid #E0E0E1;\n  margin-bottom: 5px;\n  transition: height 2s; }\n  .aminities ion-col {\n    text-align: center; }\n  .aminities ion-col ion-icon {\n      width: 27px;\n      height: 27px; }\n  .aminities p.name {\n    font-size: 8px;\n    opacity: 0.8;\n    margin: 0; }\n  .aminities .aminities-toggle {\n    position: absolute;\n    right: 16px;\n    background: #fff;\n    display: flex;\n    width: 80px;\n    height: 64px;\n    z-index: 1;\n    align-items: center;\n    margin-top: -5px; }\n  .aminities .aminities-toggle p {\n      display: block;\n      text-align: center;\n      background: #fff;\n      margin: 0;\n      width: 100%;\n      z-index: 1;\n      font-size: 20px;\n      color: #627790; }\n  .aminities.collapsed {\n    height: 60px;\n    transition: height 2s;\n    overflow: hidden; }\n  .aminities.expanded {\n    height: auto;\n    transition: height 2s; }\n  .aminities.expanded .aminities-toggle {\n      bottom: -16px; }\n  .reviews {\n  border-bottom: 1px solid #E0E0E1;\n  margin-bottom: 5px; }\n  .reviews ion-item {\n    --detail-icon-color: var(--ion-color-primary);\n    --detail-icon-opacity: 1; }\n  .reviews ion-item ion-badge {\n      --ion-color-base: #0084B1 !important;\n      --ion-color-contrast: #fff !important;\n      font-size: 13px;\n      margin-right: 5px; }\n  .reviews ion-item ion-note {\n      font-size: 13px;\n      padding-top: 16px; }\n  .description {\n  padding-bottom: 15px; }\n  .description .content.collapsed {\n    height: 55px;\n    overflow: hidden; }\n  .description .content.expanded {\n    height: auto; }\n  .description .more {\n    color: var(--ion-color-primary);\n    text-align: right;\n    font-size: 13px;\n    line-height: 16px; }\n  .havy {\n  background: #fff;\n  border-radius: 50%;\n  margin-right: 5px !important;\n  width: 40px !important;\n  height: 40px !important; }\n  .havy ion-icon {\n    color: #00bdbb; }\n  ion-icon.sc-ion-back-button-md {\n  color: black !important; }\n  .trn {\n  margin-left: -3px;\n  padding: 3px; }\n  .featured {\n  position: absolute;\n  left: 0rem;\n  background: #ED0925;\n  display: inline-block;\n  padding: 0 4px;\n  color: #FFF;\n  font-size: 8px;\n  font-weight: 500;\n  z-index: 99999;\n  height: 20px;\n  line-height: 20px; }\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
/* harmony import */ var _services_share_service__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../services/share.service */ "./src/app/services/share.service.ts");
...
var TourPage = /** @class */ (function () {
    function TourPage(activatedRoute, wpApiService, authService, navCtrl, modalController, loadingCtrl, shareService, socialSharing) {
    ...
    TourPage.prototype.shareThis = function () {
        this.shareService.shareWithOptions(this.tourData.title, this.tourData.images[0].image, this.tourData.images[0].image, this.tourData.url);
    };
    //New Function
    TourPage.prototype.openSelect = function () {
        this.selectRef.open();
    };
    TourPage.prototype.shareSocialNw = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                if (this.social == 1) {
    ...
    TourPage.prototype.shareViaEmail = function () {
        this.socialSharing.shareViaEmail(this.tourData.url, this.tourData.title, ['info@propertystays.com']).then(function () {
        }).catch(function () {
            // Error!
        });
    };
    TourPage.prototype.shareViaFacebook = function () {
        this.socialSharing.shareViaFacebookWithPasteMessageHint(this.tourData.title, this.tourData.images[0].image, this.tourData.url, this.tourData.title).then(function () {
        }).catch(function () {
            // Error!
        });
    };
    TourPage.prototype.shareViaWhatsApp = function () {
        this.socialSharing.shareViaWhatsApp(this.tourData.url, this.tourData.images[0].image, this.tourData.url).then(function () {
        }).catch(function () {
            // Error!
        });
    };
    TourPage.prototype.shareViaTwitter = function () {
        this.socialSharing.shareViaTwitter(this.tourData.title, null, this.tourData.url).then(function () {
        }).catch(function () {
            // Error!
        });
    };
    TourPage.prototype.shareViaInstagram = function () {
        this.socialSharing.shareViaInstagram(this.tourData.url, this.tourData.images[0].image).then(function () {
        }).catch(function () {
            // Error!
        });
    };
    ...
    ], TourPage.prototype, "selectRef", void 0);
    TourPage = __decorate([
        ...
        __metadata("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"],
            ...
            _services_share_service__WEBPACK_IMPORTED_MODULE_9__["ShareService"],
